...
-odac   -m0 --limiter=0.95 ;;;realtime audio out, with limiter protection
...
len@global:i = filelen("fox.wav")            ; get length of soundfile
...
instr 2
  ...
  time:k = line(0, p3, len)                   ; timepointer = soundfile duration
  sig:a = ATSsinnoi(time, 1, 0.4, 1, p4, 167) ; maximum # of partials = 167
  outs(sig, sig)
endin
