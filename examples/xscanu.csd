...
instr 1 ; Plain scanned syntnesis
  ...
  a1 xscans  0.5, cpspch(p4), 333, 0, p6 ; NOTE LEFT RIGHT TRAJECTORY (f333) IS CLEAN!
  a1 dcblock a1
  outs       a1, a1
endin
...
instr 2 ; Scan synthesis with audio injection and dual scan paths
 ...
 ; a0,aa    ins
  ...
  a1 xscans   0.3, cpspch(7.00), 333, 0, 2 ; NOTE LEFT RIGHT TRAJECTORY (f333) IS CLEAN!
  a2 xscans   0.3, cpspch(6.00), 77, 0, 2
  a1 dcblock a1
  a2 dcblock a2
  outs        a1*.5,a2*.1
endin 
