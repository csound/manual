...
instr 7
  ...
  kA = linseg(0, dur/17, 1, (17-2)*dur/17, 1, dur/17, 0) ; overal amplitude envelope
  k7 = linseg(70, dur/3, 700, dur/3, 700, dur/3, 70)     ; filter cutoff envelope
  k77 = expseg(sqrt(7), dur/2, 7.7, dur/2, sqrt(7))      ; filter resonance modulation
...
instr 77 ; What a sound without some good reverb??
  a1, a2 = reverbsc(ga1, ga2, 0.97 + 0.1/7, 7777)
  outs(a1, a2)
  ga1 = 0
  ga2 = 0
endin
