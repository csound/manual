...
[sr](../../opcodes/sr) the sample rate (default 44100)<br>
[ksmps](../../opcodes/ksmps) the number of samples for one control period (default 10)<br>
...
[nchnls](../../opcodes/nchnls) the number of audio channels (default 1)<br>
NOTE: This refers to both, output and input channels. Use [nchnls_i](../../opcodes/nchnls_i) in case input and output do not have the same number of channels.<br>
[0dbfs](../../opcodes/0dbfs) the number which serves as amplitude value for zero dB full scale (default 32768).<br>
...
[nchnls_i](../../opcodes/nchnls_i) the number of input channels (if different from [nchnls](../../opcodes/nchnls))<br>
[A4](../../opcodes/A4) the frequency set to pitch A4 (default 440)<br>
[seed](../../opcodes/seed) sets the global seed for most random generators<br>
NOTE: The syntax is `seed 0` or `seed(0)` but NOT `seed = 0`<br>
[massign](../../opcodes/massign) assigns incoming midi to a specific instrument<br>
[pgmassign](../../opcodes/pgmassign) assigns a MIDI program number to a specific instrument<br>
[ctrlinit](../../opcodes/ctrlinit) sets the initial values for a set of MIDI controllers<br>
[ftgen](../../opcodes/ftgen) generates a function table
...
- Macro definitions  
- [#include](../../opcodes/include) statements for external files  
