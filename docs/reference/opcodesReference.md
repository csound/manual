...
[midicontinue](../opcodes/midicontinue.md) - Reports incoming MIDI Continue messages at control rate.<br>
...
[typeof](../opcodes/typeof.md) - Returns the Csound type of a variable or expression as a string.<br>
