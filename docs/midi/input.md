...
* MIDI information for MIDI-triggered instruments: [veloc](../../opcodes/veloc), [midictrl](../../opcodes/midictrl), [midichn](../../opcodes/midichn) and [notnum](../../opcodes/notnum). See also [Converters](../convert).
