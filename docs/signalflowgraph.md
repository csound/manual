...
[outleta](../opcodes/outleta), for sending an arate signal from any instrument out a named port. [outletk](../opcodes/outletk), for sending a krate signal from any instrument out a named port. [outletkid](../opcodes/outletkid), similar to outletk, but receiving a krate signal only from an identified instance of a port. [outletf](../opcodes/outletf), for sending an frate signal from any instrument out a named port. [outletv](../opcodes/outletv), for sending an arate array signal from any instrument out a named port. [inleta](../opcodes/inleta), for receiving an arate signal through a named port. [inletk](../opcodes/inletk), for receiving a krate signal through a named port. [inletkid](../opcodes/inletkid), similiar to inletk, but transmitting a signal only between inlet and outlet opcodes. [inletf](../opcodes/inletf), for receiving an frate signal through a named port. [inletv](../opcodes/inletv), for receiving an arate array signal through a named port. [connect](../opcodes/connect), for routing the signal from a named outlet in a source instrument to a named inlet in a sink instrument. [alwayson](../opcodes/alwayson) for permanently activating an instrument from the orchestra header, without need of a score statement, e.g. for use as an effect processor receiving inputs from a number of sources. [ftgenonce](../opcodes/ftgenonce) for instantiating function tables from within instrument definitions, without need for f-statements in the score or ftgen opcodes in the orchestra header. 
