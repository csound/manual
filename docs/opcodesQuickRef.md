...
`ar15, ar16] `[**`loscilx`**](opcodes/loscilx.md)` xamp, kcps, ifn \`<br>
...
`ar27, ar28, ar29, ar30, ar31, ar32 `[**`in3`**](opcodes/in32.md)`2`<br>
...
`ar13, ar14, ar15, ar16 `[**`inx`**](opcodes/inx.md)<br>
...
[**`chn`**](opcodes/chn.md)`_a Sname, imode`<br>
...
[**`xout `**](opcodes/xout.md)`xoutarg1 [, xoutarg2] ... [, xoutargN]`<br>
...
[**`printf`**](opcodes/printf.md)` Sfmt, ktrig, [xarg1[, xarg2[, ... ]]]`<br>
...
[**`a(`**](opcodes/opa.md)`x) (control-rate args only)`<br>
...
[**`i(`**](opcodes/opi.md)`x) (control-rate or init-rate arg)`<br>
...
`aout `[**`lag `**](opcodes/lag.md)`ain, klagtime [, initialvalue]`<br>
...
[**`tempo `**](opcodes/tempo.md)`ktempo, istartempo`<br>
...
`a `[**`+`**](opcodes/adds.md)` b  (no rate restriction)`<br>


`-a  (no rate restriction)`<br>
`a `[**`-`**](opcodes/subtracts.md)` b  (no rate restriction)`<br>
...
`ares `[**`zamod `**](opcodes/zamod.md)`asig, kzamod`<br>
...
`kres `[**`zkmod `**](opcodes/zkmod.md)`ksig, kzkmod`<br>
...
[**`trim`**](opcodes/trim.md)` xarray, klen`<br>
...
`kres `[**`system`**](opcodes/system.md)` ktrig, Scmd, [knowait]`<br>
