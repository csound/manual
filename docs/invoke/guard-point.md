...
Tables are generated by subroutines called [GEN Routines](/reference/genRoutinesRef). Traditionally GEN Routines are called in the score by a [f-statement](/scoregens/f). Most users nowadays create function tables in the orchestra part of the code via the [ftgen](/opcodes/ftgen) opcode.

This statement creates a table with 1024 points via [GEN10](/scoregens/gen10), resulting in a sine, in the *score* section:
