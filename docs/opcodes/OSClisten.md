...
> :memo: **Note**
>
> Up to Csound 6, this opcode was called *OSClisten*.
...
=== "Modern"
    ...
    ``` csound-csd title="oscmidircv-modern.csd." linenums="1"
    --8<-- "examples/oscmidircv-modern.csd"
    ```
