...
The result is a new vectorial control signal that overrides old values of _ifn1_. If you want to keep the old ifn1 vector, use [vcopy_i](../../opcodes/vcopy_i) opcode to copy it in another table. You can use _kdstoffset_ and _ksrcoffset_ to specify vectors in any location of the tables.
...
vectors are divided). There is an i-rate version of this opcode called [vdivv_i](../../opcodes/vdivv_i).
