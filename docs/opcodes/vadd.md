...
Note that this opcode runs at k-rate so the value of _kval_ is added every control period. Use with care or you will end up with very large numbers (or use [vadd_i](../../opcodes/vadd_i)).
