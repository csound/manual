...
Note that this opcode runs at k-rate so the value of _kval_ is multiplied every control period. Use with care or you will end up with very large numbers (or use [vmult_i](../../opcodes/vmult_i)).
