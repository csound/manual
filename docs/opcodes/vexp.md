...
Note that this opcode runs at k-rate so the value of _kval_ is processed every control period. Use with care or you will end up with very large (or small) numbers (or use [vexpi](../opcodes/vexp_i.md)).
