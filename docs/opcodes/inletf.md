...
During performance, the frate inlet signal is received from each instance of an instrument containing an outlet port to which this inlet has been connected using the [See also](../../opcodes/connect)e>
