...
During performance, the arate array output signal is sent to each instance of an instrument containing an inlet port to which this outlet has been connected using the [See also](../../opcodes/connect)e>
