...
_mincer_ implements phase-locked vocoder processing using function tables containing sampled-sound sources, with [GEN01](../../scoregens/gen01), and _mincer_ will accept deferred allocation tables.
