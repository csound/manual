...
_system_ and _systemi_ call any external command understood by the operating system, similarly to the C function `system()`. _systemi_ runs at i-time only, while _system_ runs both at initialization and performance time.
