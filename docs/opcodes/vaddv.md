...
The result is a new vectorial control signal that overrides old values of ifn1. If you want to keep the old ifn1 vector, use [vcopyi](../opcodes/vcopy_i.md)opcode to copy it in another table. You can use _kdstoffset_ and _ksrcoffset_ to specify vectors in any location of the tables.
...
vectors are added). There is an i-rate version of this opcode called [vaddvi](../opcodes/vaddv_i.md).
