...
; -o Scanu_Shengzheng_Zhang.wav -W ;;; for file output any platform
</CsOptions>
<CsInstruments>
...
scanu2 1, 0.1,ifnvel, ifnmass,ifnstif,ifncentr, ifndamp,kmass, kstif, kcentr, kdamp, ileft, iright,kpos,kstrngth, a2*0.5, 0.2, 1
